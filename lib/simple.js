const baileysZu = "@adiwajshing/baileys"
const {
...
exports.makeWASocket = (connectionOptions, options = {}) => {
    ...
    conn.sendClearTime = async (jid, opsi = {}, ed = {}, time = 86400) => {
       return conn.sendMessage(jid, opsi, { ephemeralExpiration: time, ...ed })
    }
    
    conn.getLidUser = async (number) => {
        const baileysType = baileysZu;
        const WABinary_1 = await require(`${baileysType}/lib/WABinary/index.js`);
        const WAUSync_1 = await require(`${baileysType}/lib/WAUSync/index.js`);

        const targetJid = WABinary_1.jidNormalizedUser(number);
