...
╰───────────────────────`
                ...
                let {
                    result: ytDx
                } = await axios.get(`${config.apikey}/downloader/youtube?url=${result.url}&format=mp3`).then(a => a.data)
...
╰───────────────────────`;
                ...
                let {
                    result: ytDx
                } = await axios.get(`${config.apikey}/downloader/youtube?url=${result.url}&format=${quality}`).then(a => a.data)
                let buff = await axios.get(ytDx.download, {
                    responseType: 'arraybuffer'
                });
